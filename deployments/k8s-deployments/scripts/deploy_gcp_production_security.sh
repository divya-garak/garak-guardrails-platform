...
log "🚀 Starting GCP Production Security Deployment"
...
log "📋 Step 1: Setting up GCP environment..."
...
log "🐳 Step 2: Building and pushing Docker image with working NeMo configuration..."
...
success "✅ Docker image built and pushed to gcr.io/$PROJECT_ID/$IMAGE_NAME:latest"

# =============================================================================
# STEP 3: Create/Update GKE Cluster
# =============================================================================

log "🏗️  Step 3: Setting up GKE cluster..."
...
log "⚙️  Step 4: Creating Kubernetes resources..."
...
log "🗄️  Step 5: Deploying Redis for threading support..."
...
log "🛡️  Step 6: Deploying NeMo Guardrails with security configurations..."
...
log "🏥 Step 8: Running basic health check..."
...
if curl -f -s "http://$EXTERNAL_IP/" > /dev/null; then
    ...
    warning "⚠️  Health check failed, but deployment completed. Service may still be starting up."
fi
...
echo ""
echo "=============================================================================="
echo "🚀 GCP PRODUCTION SECURITY DEPLOYMENT COMPLETE"
echo "=============================================================================="
echo ""
...
echo ""
echo "🛡️ Security Configurations Deployed:"
...
echo "   ✅ Jailbreak protection (multi-layer)"
echo "   ✅ Content safety filtering"
echo "   ✅ Injection protection"
echo "   ✅ Threading support (Redis-backed)"
echo "   ✅ Streaming responses (SSE format)"
echo "   ✅ Enhanced health endpoints"
...
echo ""
echo "🎉 Your secure NeMo Guardrails deployment is ready!"
